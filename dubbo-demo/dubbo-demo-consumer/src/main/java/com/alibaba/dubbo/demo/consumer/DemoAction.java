...
public class DemoAction {
	...
	public void start() throws Exception {
		...
		for (int i = 0; i < 10000; i++) {
			...
			imp.setBidFloor(1.1*i);
			imp.setId("abc"+i);
			List<Impression> imprs = new ArrayList<Impression>(1);
			imps.add(impr);
			request.setImpressions(imprs);
			bidService.bid(req);
//			System.out.println();
//			System.out.println("SUCCESS: got bid response id: " + bidService.bid(request).getId());
		...
		System.out.println("SUCCESS: got long" + bidService.bid(10));
		System.out.println("SUCCESS: got String" + bidService.bid(10, "test_"));
	}
